...
function enterKey(e) {
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine(
      'localhost@terminal.niraj:~$ <span class="command">"'+
        command.innerHTML +
        '</span>',
      'liner no-animation',
      0
...
function commander(cmd) {
  switch (cmd) {
    ...
    case 'weather':
      ...
      break;
    case 'pwd':
      addLine('localhost/niraj/terminal', 'color3', 0);
      break;
    default:
      addLine(
